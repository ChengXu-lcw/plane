...
public:
	...
	virtual void OnLButtonDown(POINT pt) // WM_LBUTTONDOWN
	{
	
	}
	virtual void OnLButtonUp(POINT pt) // WM_LBUTTONUP
	{
	
	}
	virtual void OnMouseMove(POINT pt) // WM_MOUSEMOVE
	{
